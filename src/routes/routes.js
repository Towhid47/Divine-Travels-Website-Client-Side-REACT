...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://divine-travels-server.vercel.app/destinations/${params.id}`
          ),
      },
      {
        path: "/services",
      ...
      },
      {
        ...
        loader: () => fetch("https://divine-travels-server.vercel.app/reviews"),
      },
      {
    ...
    element: (
      <>
        ...
        <div className="text-center mt-2">
          <Link to="/">
            <Button className="button-color">Go Back To Homepage</Button>
          </Link>
        </div>
      </>
    ),
